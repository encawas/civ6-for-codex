...
- Migrate Phase 1B OPEN Proposals whose waits were already resumed to deterministic system invalidation before enablement, and prohibit generic Proposal resume after APPROVE/REJECT becomes available.
