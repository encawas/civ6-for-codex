...
4. Research execution intent must use an ACTIVE research Mission whose desired outcome names the technology to pursue. Do not encode tool calls or arbitrary action JSON.
